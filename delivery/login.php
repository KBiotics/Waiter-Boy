...
<img src="../meta/Out for Delivery.png" alt="logo" class="logo"><br>
<h2>Login</h2>
	<ul class="tabs">
		<li class="active">Delivary Guy</li>
	</ul>
...
if(isset($_POST['alogin'])){
   ...
   if ($email != "" && $password != ""){
        ...
        $sql_query = "SELECT * FROM `delivary_guys` WHERE uname='".$email."' and password='".$password."'";
        $result = mysqli_query($con,$sql_query);
        $row = mysqli_fetch_assoc($result);
		if($row!=0){
			do
			{
        $Attname=$row['full_name'];
